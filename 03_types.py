...
# - int to str
b = 79
print(" value of g as string is :" + str(b))
# - bool to str
c = True
print("the value of t is :" + str(c))
# - str to float

d = "07545.09986437437"

print("the values of d is :" + str(float(d)))


# - float to str
e = 0.987557354430000000000000000000001
print("the value of e is:" + str(e))
# - int to float
f = 23335
print("the value of e is:" + str(float(f)))
# - float to int, notice what hapens to the fractional part of a

g = 56.9765328823932
print("the value of g is :" + str(int(g)))
