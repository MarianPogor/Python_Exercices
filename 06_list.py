...
months = ["January" , "February" , "March" , "April" , "Maj", "June" , "July", " August", "September" , "Octomber" , "November" , "December"]
...
numbers_odd = list(range(1, 50))
my_list = []


for x in numbers_odd:
	if x % 2 == 1:
		print(x)
...
numbers_to100 = list(range(1, 100))
sum2 =0

for x in numbers_to100:
	sum2 = sum2 + x 
...
random_numbers = [10,15,22,90,867637,654]
random_numbers.sort()
print(random_numbers[-1])

print("Largest element is:", max(random_numbers)) 
...
prime = int(input("Please enter the number of rows : ")) 
